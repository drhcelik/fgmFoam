...

{
    forAll(tableNames_, i)
    {
        ...
        tables_.set(i, FGMTable::New(mesh, tablePath_, tableNames_[i]));
    }
    
    paramNames_[0] = "varPV_param";
    paramNames_[1] = "PV_param";
    paramNames_[2] = "varZ_param";
    paramNames_[3] = "Z_param";
...
List<List<List<scalarList> > >  tableSolver::tableValues( const label& i) const
{
